...
describe('Block', () => {
    ...
    describe('mineBlock()', () => {
        ...
        it('sets a `hash` that matches the difficulty critiria', () => {
    ...
    describe('adjustDifficulty', () => {
        it('raises a difficulty for a quickly minded block', () => {
            expect(Block.adjustDifficulty({originalBlock: block, timestamp: block.timestamp + MINE_RATE - 100})).
            toEqual(block.difficulty + 1);
        });

        it('lowers a difficulty for a slowly minded block', () => {
            expect(Block.adjustDifficulty({originalBlock: block, timestamp: block.timestamp + MINE_RATE + 100})).
            toEqual(block.difficulty - 1);
        });

        it('has a limit lower of 1', () => {
            block.difficulty = -1;
